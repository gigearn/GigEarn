...
const VerificationQueue = () => {
  ...
  const filteredStoreVerifications = pendingStoreVerifications.filter(store =>
    store.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
    store.email.toLowerCase().includes(searchTerm.toLowerCase()) ||
    store.phone.includes(searchTerm)
  );

  const filteredGigVerifications = pendingGigVerifications.filter(gig =>
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 pb-6" style={{ paddingTop: '0px !important', marginTop: '0px !important' }}>
      {/* Header */}
      <div className="mb-4" style={{ marginTop: '0px !important' }}>
        ...
        {activeTab === 'stores' && (
          <>
            {filteredStoreVerifications.length === 0 ? (
              ...
              filteredStoreVerifications.map((store) => (
                <div key={store.userId} className="bg-card border border-border rounded-lg p-6">
        ...
        {activeTab === 'gigs' && (
          <>
            {filteredGigVerifications.length === 0 ? (
              ...
              filteredGigVerifications.map((gig) => (
                <div key={gig.userId} className="bg-card border border-border rounded-lg p-6">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-4">
